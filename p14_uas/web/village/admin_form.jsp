...
<div class="body clearfix">
		...
		<div class="table clearfix">
			<div class="menu clearfix">
				...
				<div class="submenu">
					<h3>Village</h3>
					<ul>
						<li><a href="Village?action=manage" title="Manage">Manage</a></li>
						<% if (action.equalsIgnoreCase("add")) {%>
	...
	<div class="content">
		<div class="wrapper">
			<% if (action.equalsIgnoreCase("add")) {%>
			<h1 class="small">Add Village</h1>
			<%} else {%>
			<h1 class="small">Update Village</h1>
			<% }%>
			
        <form method="POST" action="Village" name="">
            <fieldset class="clearfix">
                ...
                <div class="clearfix">
                    <label>Village</label>
                    <div class="desc">
                        <input type="text" name="village_name" value="<c:out value="${model.village}" />" />
                    </div>
                </div>
                <div class="clearfix">
                    <label>Zipcode</label>
                    <div class="desc">
                        <input type="text" name="zipcode" value="<c:out value="${model.zipcode}" />" />
                    </div>
                </div>
                <div class="clearfix">
                    <label>Publish</label>
